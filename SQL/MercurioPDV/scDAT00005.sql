CREATE TABLE NFCE (
    ...
    EX                   INTEGER,
    CODIGO_CUPOM         COD_EXTENDIDO /* COD_EXTENDIDO = VARCHAR(50) NOT NULL */
);

ALTER TABLE NFCE ADD CONSTRAINT PK_C000061 PRIMARY KEY (CODIGO);
...
ALTER TABLE CONFIG ADD VIAS_IMPRESSAO INTEGER;
ALTER TABLE NFCE ADD PROTOCOLO_NFCE VARCHAR(30);
ALTER TABLE NFCE ADD PROTOCOLO_DATAHORA_NFCE VARCHAR(30);
ALTER TABLE NFCE ADD NFE_CANC_DATAHORA VARCHAR(30);
ALTER TABLE NFCE ADD NFE_CANC_PROTOCOLO VARCHAR(100);