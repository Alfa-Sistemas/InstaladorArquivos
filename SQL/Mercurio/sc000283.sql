ALTER TABLE C000001 ADD NF_DESCONSIDERAR_VOLUME VARCHAR(1) DEFAULT 'N';
UPDATE C000001 SET NF_DESCONSIDERAR_VOLUME = 'N';
...
begin
  ...
  if ((SELECT NF_DESCONSIDERAR_VOLUME FROM C000001) = 'S') then
  begin
    nfVol_Qtde = 1;
  end
